...
public class CAService : ICAService
{
    ...
    public List<GrantInfo> GetGrantsByPerson(int personId)
    {
        var grants = from g in cae.GrantRequests
                     ...
                     select new { g.GrantRequestDate, g.GrantRequestExplanation, g.GrantType.GrantTypeName, g.GrantRequestAmount, r.GrantRequestStatus };
    ...
    public List<GrantType> GetGrantTypes()
    {
        ...
        return gTypes;
    } // end public list<granttype> GetGrantsTypes();
    ...
    {
        bool result = true;
        int success = cae.usp_Register(p.LastName, p.FirstName, p.Email, p.Password, p.Apartment, p.Street, p.City, p.Street, p.ZipCode, p.HomePhone, p.WorkPhone);
